 ...
 * @author charles
 */
public class USDinerXMLMenuCreator extends MenuCreatorAbstractFactory{

       @Override
    public IReader createReader() {
        return MenuReaderFactory.generateReader("US");
    }

    @Override
    public IMenuGenerator createMenuCreator() {
        return MenuGeneratorFactory.generateCategoryMenu("Diner", createReader());
    }

    @Override
    public IMenuFormatter createMenuFormatter() {
        return MenuFormatterFactory.generateFormatter("XML", createMenuCreator());
    }
}
